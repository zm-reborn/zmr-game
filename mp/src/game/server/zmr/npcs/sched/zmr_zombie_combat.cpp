...
CZombieCombatSchedule::CZombieCombatSchedule()
{
    m_vecFaceTowards = vec3_origin;

    m_pChaseSched = new CZombieChaseSchedule;
...
void CZombieCombatSchedule::OnStart()
{
}

void CZombieCombatSchedule::OnContinue()
{
...
void CZombieCombatSchedule::OnUpdate()
{
...
void CZombieCombatSchedule::OnAcquiredEnemy( CBaseEntity* pEnt )
{
    OnSightGained( pEnt );
}

void CZombieCombatSchedule::OnSightGained( CBaseEntity* pEnt )
{
    //
...
void CZombieCombatSchedule::OnDamaged( const CTakeDamageInfo& info )
{
...
void CZombieCombatSchedule::OnHeardSound( CSound* pSound )
{
...
void CZombieCombatSchedule::OnCommanded( CBasePlayer* pCommander, ZombieCommandType_t com )
{
    OnContinue();
...
void CZombieCombatSchedule::OnQueuedCommand( CBasePlayer* pPlayer, ZombieCommandType_t com )
{
    OnContinue();
}

bool CZombieCombatSchedule::ShouldCareAboutThreat() const
{
...
//
bool CZombieCombatSchedule::GotoThreatPosition( const Vector& vecEnd )
{
...
// Find an enemy to attack!
//
CBaseEntity* CZombieCombatSchedule::EvaluateEnemies()
{
    auto* pOuter = GetOuter();
