...
#ifdef ZMR // ZMRCHANGE: Increase the default npc interp
static ConVar  cl_interp_npcs( "cl_interp_npcs", "0.2", FCVAR_USERINFO, "Interpolate NPC positions starting this many seconds in past (or cl_interp, if greater)" );
#else
