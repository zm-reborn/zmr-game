...
COptionsSubAudio::COptionsSubAudio(vgui::Panel *parent) : PropertyPage(parent, NULL)
{
   ...
   m_pMuteLoseFocusCheckBox = new CCvarToggleCheckButton( this, "snd_mute_losefocus", "#GameUI_SndMuteLoseFocus", "snd_mute_losefocus" );
...
void COptionsSubAudio::OnResetData()
{
	...
	m_pMuteLoseFocusCheckBox->Reset();
...
void COptionsSubAudio::OnApplyChanges()
{
	...
	m_pMuteLoseFocusCheckBox->ApplyChanges();
